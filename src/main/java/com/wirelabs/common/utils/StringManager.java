...
public class StringManager {
     ...
     *
     * @param value
     *            <code>byte[]</code> a ser convertido
     * @param length
     *            tamanho do <code>byte[]</code> a ser convertido
    ...
    public String capitalize(final String arg0) {
        ...
        final char chars[] = arg0.toLowerCase()
                .replaceAll("#", " ")
                .toCharArray();
    ...
    public String fillLeft(final String arg0, final String arg1, final int arg2) {
        ...
        while (result.length() < arg2 - value.length()) {
            if (result.length() > 0 && String.valueOf(result.charAt(0))
                    .equals("-")) {
                result.append("0");
            } else {
                result.append(s);
    ...
    public String formatString(final String arg0) {
        ...
        if (result != null) {
            for (int i = 0; i < MASK.length(); i++) {
                ...
                result = result.replaceAll(String.valueOf(MASK.toLowerCase()
                        .charAt(i)), String.valueOf(
                                CORRECT.toLowerCase()
                                        .charAt(i)));
            }
     ...
     *
     * @param value
     *            <code>String</code> a ser formatado
     * @param mask
     *            <code>String</code> com a mascara a ser utilizada
     * @return Exemplos:<br/>
     *         <br/>
    ...
    public String formatString(final String value, final String mask) {
        ...
        for (int i = 0; i < mask.length(); i++) {
            ...
            if (byteMask.contains("0") || byteMask.contains("#") || byteMask.contains("X") || byteMask.contains("!")) {
                if (byteMask.contains("0") && byteValue.trim()
                        .length() == 0) {
                    byteValue = "0";
                } else if (byteMask.contains("#") && byteValue.trim()
                        .length() == 0) {
                    byteValue = "";
     ...
     *
     * @param aThrowable
     *            objeto <code>Throwable</code> referente a excecao ocorrida
    ...
    public Boolean isNullOrTrimEmpty(final String... arrayStrings) {
        for (final String item : arrayStrings) {
            if (item == null || item.equals("null") || item.trim()
                    .equals("")) {
                return true;
            }
        }
     ...
     *
     * @param value
     *            <code>String</code> a ser preenchido a esquerda
     * @param fillChar
     *            <code>String</code> a ser utilizado como preenchimento
     * @param length
     *            tamanho do <code>String</code> a ser retornado preenchida ou
     ...
     *
     * @param value
     *            <code>String</code> a ser preenchido a direita
     * @param fillChar
     *            <code>String</code> a ser utilizado como preenchimento
     * @param length
     *            tamanho do <code>String</code> a ser retornado preenchida ou
     ...
     *
     * @param value
     *            <code>String</code> a ser analisada
     * @param charToRemove
     *            <code>String</code> com os caracteres a serem removidos
     * @return Exemplos:<br/>
     *         <br/>
        ...
        for (int i = 0; i < value.length(); i++) {
            ...
            for (int x = 0; x < charToRemove.length() && byteOk; x++) {
                if (value.substring(i, i + 1)
                        .compareTo(charToRemove.substring(x, x + 1)) == 0) {
                    byteOk = false;
                }
     ...
     *
     * @param value
     *            <code>String</code> a ser replicada
     * @param count
     *            quantidade de replicacoes<br/>
     ...
     *
     * @param value
     *            <code>String</code> original
     * @param length
     *            quantidade de bytes a partir da posicao final<br/>
     ...
     *
     * @param value
     *            <code>String[]</code> com as linhas
     * @param charToLocate
     *            <code>String</code> a ser pesquisado
     * @param initialPos
     *            posicao inicial para iniciar a procura
    ...
    public int stringArraySearchFirstChar(final String[] value, final String charToLocate, final int initialPos) {
        ...
        for (int i = initialPos; i < value.length; i++) {
            if (value[i].substring(0, 1)
                    .equalsIgnoreCase(charToLocate)) {
                return i;
            }
        }
     ...
     *            <code>Boolean</code> remove todos os caracteres ASC > 127<br/>
     ...
     *            <code>String</code> original
     * @param beginIndex
     *            posicao inicial (inclusive). Posicao inicial de uma
     *            <code>String</code> comeca em <code>ZERO</code>
     * @param length
     *            quantidade de bytes a partir da posicao inicial ou
